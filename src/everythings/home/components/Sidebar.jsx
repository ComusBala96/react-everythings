  ...
  return (
    <>
      <div
        ...
        } fixed h-screen bg-white z-30 top-0 right-0 md:left-0 w-[45%] md:scale-100 shadow-2x border-r `}
      >
        ...
        <div className="grid grid-flow-row ">
          ...
          >
            <div className="col-span-7 md:col-span-11">
              <input
                ...
                id="search"
                placeholder=" Search"
                className={`h-8 w-[32vw] md:w-[23.5vw] lg:w-[20vw] xl:w-[14.5vw] outline-none focus:px-2 border  rounded-md ${
                  sidebarMenu ? "duration-300" : "md:hidden duration-300"
                } placeholder:text-sm`}
              />
            </div>
          ...
          <div
            className={`overflow-y-auto  h-sideBarScroll scroll-smooth ${
              sidebarMenu ? "mx-1 md:mx-4" : "mx-1 "
            } mb-1`}
          >
            <div className={` bg-gray-100 pt-3 pb-4 rounded-lg`}>
              <div className={` ${sidebarMenu ? "mx-1 md:mx-4" : "md:mx-2"}`}>
                <div
                  className={`grid grid-flow-col grid-cols-6 ${
                    sidebarMenu ? "md:grid-cols-5" : "md:grid-cols-2"
                  }  shadow-lg border rounded-md justify-center items-center space-x-1  md:space-x-2 py-2 hover:bg-blue-400 hover:text-white cursor-pointer`}
                ...
                >
                  ...
                  <span
                    className={`${
                      sidebarMenu ? "block" : "md:hidden"
                    } text-sm md:text-base col-span-4 md:col-span-3`}
                  >
                    Social Media
                  </span>
                  <div className="">
                ...
                >
                  <NavLink to="/home/reels" className="no-underline ">
                    <div
                  ...
                  <NavLink to="/home/posts" className="no-underline ">
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                          ? "grid-cols-4"
                  ...
                  <NavLink to="/home/videos" className="no-underline ">
                    {" "}
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                    ...
                    >
                      <BsCameraVideoFill className=" cursor-pointer mx-auto" />
                      <span
                        className={` ${
                          sidebarMenu ? "" : "md:hidden"
                        } text-sm md:text-base col-span-3`}
                ...
                <div
                  className={`shadow-lg border rounded-md grid grid-flow-col grid-cols-6 ${
                    sidebarMenu ? "md:grid-cols-5" : "md:grid-cols-2 "
                  } justify-center items-center mt-3   md:space-x-2 py-2  hover:bg-blue-400 hover:text-white cursor-pointer`}
                ...
                >
                  ...
                  <span
                    className={`${
                      sidebarMenu ? "md:inline-block" : "md:hidden"
                    } text-sm md:text-base col-span-4 md:col-span-3`}
                  >
                    Entertainment
                  </span>
                ...
                >
                  <NavLink to="/home/movies" className="no-underline ">
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                          ? "grid-cols-4"
                  ...
                  <NavLink to="/home/shorts" className="no-underline ">
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                          ? "grid-cols-4"
                  ...
                  <NavLink to="/home/kids" className="no-underline ">
                    {" "}
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                  ...
                  <NavLink to="/home/education" className="no-underline ">
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                          ? "grid-cols-4"
                ...
                <div
                  className={`shadow-lg border rounded-md grid grid-flow-col grid-cols-6 ${
                    sidebarMenu ? "md:grid-cols-5" : "md:grid-cols-2"
                  } items-center mt-3 space-x-1  md:space-x-2 py-2  hover:bg-blue-400 hover:text-white cursor-pointer`}
                ...
                >
                  ...
                  <div className="">
                    <FaAngleLeft
                      className={`${
                        sidebarBusiness ? "-rotate-90" : "rotate-0"
                      }`}
                    />
                  </div>
                </div>
                ...
                >
                  <NavLink to="/home/buy" className="no-underline ">
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                          ? "grid-cols-4"
                  ...
                  <NavLink to="/home/sell" className="no-underline ">
                    {" "}
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                  ...
                  <NavLink to="/home/investment" className="no-underline ">
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                          ? "grid-cols-4"
                  ...
                  <NavLink to="/home/rent" className="no-underline ">
                    <div
                      className={`shadow-md border rounded-md grid grid-flow-col  ${
                        sidebarMenu
                          ? "grid-cols-4"
