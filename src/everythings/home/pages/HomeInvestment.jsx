...
export default function HomeInvestment() {
  ...
  const [dotAction, setDotAction] = useState(true);
  return (
    <>
      <div className="bg-white md:py-3 ">
        <div className=" grid grid-flow-row gap-4  mx-auto  md:w-96 lg:w-[60%] xl:w-[45%]">
              ...
              <div className="relative col-span-1 grid justify-center">
                <span className="cursor-pointer">
                  <BiDotsHorizontalRounded
                    ...
                    onClick={() => setDotAction(!dotAction)}
                  />
                </span>
                <div
                  className={`${
            ...
            <div className="">
              <div className="ml-2 px-2 py-3 ">
                <span className="">
                  ...
                  Consectetur fuga ratione voluptates voluptatibus
                  reprehenderit, pariatur excepturi non quaerat amet iusto
                  aperiam quibusdam labore nulla possimus laborum obcaecati,
                  quidem neque molestias.
                </span>
              </div>
              <div
                style={{
