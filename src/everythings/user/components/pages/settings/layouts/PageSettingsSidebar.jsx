        ...
        <div className=" bg-white shadow-sm ml-2">
          <div className="border-b py-1 ">
            <div className="flex justify-between items-center mx-4">
              <span className="text-lg py-2">Page Settings</span>
              <BiDotsHorizontal className=" cursor-pointer" />
            </div>
          </div>
          <NavLink to="/user/page/settings/coustom" className="no-underline">
          ...
          <NavLink to="/user/page/settings/blog" className="no-underline">
            <div className="border-b py-1 hover:bg-blue-400">
              <div className="flex justify-between items-center mx-4">
          ...
          <NavLink to="/user/page/settings/article" className=" no-underline">
            <div className="border-b py-1 hover:bg-blue-400">
              <div className="flex justify-between items-center mx-4">
          ...
          <NavLink to="/user/page/settings/news" className="no-underline">
            <div className="border-b py-1 hover:bg-blue-400">
              <div className="flex justify-between items-center mx-4">
