...
export default function ArticlesContent() {
  useEffect(() => {
    ...
    if (url === "http://localhost:3000/user/posts/articles") {
    ...
    if (screenSize > 1471) {
      document.getElementById("articlesSidebarBox").classList.remove("hidden");
    }
    ...
    function articleBox() {
      ...
      if (screenSize > 1471) {
        document
          .getElementById("articlesSidebarBox")
  ...
  return (
    <>
      <div className="col-span-7 bg-white ">
        <div className="m-4">
          <div className="shadow-md  mb-4 duration-100" id="articlesContentBox">
