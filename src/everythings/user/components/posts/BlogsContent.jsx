...
export default function BlogsContent() {
  useEffect(() => {
    ...
    if (url === "http://localhost:3000/user/posts/blogs") {
    ...
    if (screenSize > 1468) {
      document.getElementById("blogSidebarBox").classList.remove("hidden");
    }
          ...
          <div className=" shadow-md  mb-4 duration-100">
            ...
            <div className=" flex flex-col m-6 gap-4 border-b pb-3">
              <label htmlFor="title" className="font-semibold">
                Blog Title: <span className="text-red-600 font-bold">*</span>
              </label>
              <textarea
                type="text"
                name=""
            ...
            <div className="flex flex-col m-6 gap-4 ">
              <label htmlFor="files" className="font-semibold">
                Blog Files: <span className="text-red-600 font-bold">*</span>
              </label>
