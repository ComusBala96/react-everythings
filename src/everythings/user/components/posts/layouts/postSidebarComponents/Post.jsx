...
export default function Post() {
  return (
    <>
      <div
        className="bg-white shadow-md pt-2 mb-2 duration-100 hidden"
        id="postSidebarBox"
      >
        ...
        <div className=" flex flex-col m-6 space-y-2 border-b">
        ...
        <div className="flex flex-col m-6 space-y-2 ">
          <label htmlFor="files" className="font-semibold">
            Post Files: <span className="text-red-600 font-bold">*</span>
          </label>
        ...
        <div className="text-right mr-10 py-4 space-x-2">
